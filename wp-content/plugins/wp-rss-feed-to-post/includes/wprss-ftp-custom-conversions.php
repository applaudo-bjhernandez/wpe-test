...
// Import YouTube description
add_filter('wprss_ftp_converter_post_content', function ($content, $source, SimplePie_Item $item) {
    if (wprss_is_url_youtube($item->get_permalink())) {
        return $item->get_enclosure()->description;
    }

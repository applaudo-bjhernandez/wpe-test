...
if ( class_exists('WPRSS_Help') ) {
    ...
    $tooltips = array(
        ...
        // Attachments
        'audio_player'              => __('Enable this option to show an audio player in the post content for posts that contain an enclosure that links to an audio file.', WPRSS_TEXT_DOMAIN),
        'audio_player_pos'          => __('Choose the position in the post content where the audio player should be added', WPRSS_TEXT_DOMAIN),
